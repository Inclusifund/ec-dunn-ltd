      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sectors.map((sector) => (
            <div
              key={sector.name}
              className="bg-white rounded-lg p-6 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow"
            >
              ...
              <div>
                <h3 className="font-bold text-navy mb-1">{sector.name}</h3>
